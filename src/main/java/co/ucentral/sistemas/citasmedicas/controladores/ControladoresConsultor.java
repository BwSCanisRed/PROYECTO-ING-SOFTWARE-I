...
//    public ResponseEntity<Map<String, Object>> actualizarEstado(@RequestBody AfiliacionDto afiliacionDto) {
//        Map<String, Object> response = new HashMap<>();
//        try {
//
//            Afiliacion afiliacion = repositorioAfiliacion.findById(afiliacionDto.getIdAfiliacion()).orElseThrow();
//            afiliacion.setEstadoSolicitud(afiliacionDto.getEstadoSolicitud());
//            repositorioAfiliacion.save(afiliacion);
//
//            Afiliado nuevoAfiliado = new Afiliado();
//            nuevoAfiliado.setIdentificacion(afiliacionDto.getIdAfiliacion());
//            nuevoAfiliado.setNombre(afiliacionDto.getNombre());
//            nuevoAfiliado.setMotivo(afiliacionDto.getMotivo());
//            nuevoAfiliado.setEstado(true);
//            nuevoAfiliado.setAfiliacion(afiliacion);
//            repositorioAfiliado.save(nuevoAfiliado);
//
